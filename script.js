document.getElementById('todo1').onclick = function(e) {
    ...
    if (this.checked) {
        textTodo.innerHTML = "Không có người yêu";
    } else {
        textTodo.innerHTML = "Có người yêu";
    }
}
...
document.getElementById('todo4').onclick = function(e) {
    ...
    if (this.checked) {
        textTodo.innerHTML = "Giảm cân thành công 5kg";
    } else {
        textTodo.innerHTML = "Tăng cân thành công 5kg";
    }
}
